                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    Log.d("TAG", muid + " " + mitemname);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(mitemname).child("Offers").child(currentId).child("Item_RFT").setValue(mReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(mitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(mPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String gadgetitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(gadgetitemname).child("Offers").child(currentId).child("Item_RFT").setValue(gadgetReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(gadgetitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(gadgetPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String gameitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(gameitemname).child("Offers").child(currentId).child("Item_RFT").setValue(gameReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(gameitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(gamePrefItem);
                                                    ...
                                                    if (snapshot.child("items").child(muid).child(gameitemname).child("Offers").child(currentId).hasChild("Images")) {
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String bagitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(bagitemname).child("Offers").child(currentId).child("Item_RFT").setValue(bagReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(bagitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(bagPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String gitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(gitemname).child("Offers").child(currentId).child("Item_RFT").setValue(groceryReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(gitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(groceryPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String furniitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(furniitemname).child("Offers").child(currentId).child("Item_RFT").setValue(furnitureReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(furniitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(furniturePrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String bnkitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(bnkitemname).child("Offers").child(currentId).child("Item_RFT").setValue(bnkReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(bnkitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(bnkPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String appliitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(appliitemname).child("Offers").child(currentId).child("Item_RFT").setValue(appliancesReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(appliitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(appliancesPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String motoritemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(motoritemname).child("Offers").child(currentId).child("Item_RFT").setValue(motorReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(motoritemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(motorPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String audioitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(audioitemname).child("Offers").child(currentId).child("Item_RFT").setValue(audioReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(audioitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(audioPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String schoolitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(schoolitemname).child("Offers").child(currentId).child("Item_RFT").setValue(schoolReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(schoolitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(schoolPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String waitemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(waitemname).child("Offers").child(currentId).child("Item_RFT").setValue(wReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(waitemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(wPrefItem);
                                            ...
                                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    String otheritemname = getIntent().getStringExtra("itemname");
                                                        ...
                                                        databaseReference.child("items").child(muid).child(otheritemname).child("Offers").child(currentId).child("Item_RFT").setValue(otherReasonForTrading);
                                                        ...
                                                        databaseReference.child("items").child(muid).child(otheritemname).child("Offers").child(currentId).child("Item_PrefItem").setValue(otherPrefItem);
                                                    ...
                                                    if (snapshot.child("items").child(muid).child(otheritemname).child(currentId).hasChild("Images")) {
