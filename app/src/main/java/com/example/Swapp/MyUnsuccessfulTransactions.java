...
import Swapp.R;
    ...
    public class MyUnsuccessfulTransactions extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            transactionTabLayout.selectTab(transactionTabLayout.getTabAt(3));
            transactionTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
                @Override
                public void onTabSelected(TabLayout.Tab tab) {
                    switch (tab.getText().toString()) {
                        case "Accepted offers":
                            Intent intent = new Intent(MyUnsuccessfulTransactions.this, MyItemCurrentTransaction.class);
                            startActivity(intent);
                            overridePendingTransition(0, 0);
                            break;
                        case "Offers sent":
                            Intent intent1 = new Intent(MyUnsuccessfulTransactions.this, MyOffersSentTransaction.class);
                            startActivity(intent1);
                            overridePendingTransition(0, 0);
                            break;
                        case "Successful":
                            Intent intent2 = new Intent(MyUnsuccessfulTransactions.this, MySuccessfulTransactions.class);
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()) {
                        case R.id.inbox:
                            databaseReferenceUrl.child("users").child(uid).addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    Intent intent = new Intent(MyUnsuccessfulTransactions.this, Messages.class);
                        ...
                        case R.id.home:
                            ...
                            return true;
                        case R.id.offers:
                            Intent intent2 = new Intent(MyUnsuccessfulTransactions.this, OfferMainAcitvity.class);
                            startActivity(intent2);
                            overridePendingTransition(0, 0);
                            return true;
            ...
            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot ds : snapshot.getChildren()) {
                        if (ds.child("Transaction_Status").getValue(String.class).equals("Unsuccessful") &&
