...
public class offerItem_S2 extends AppCompatActivity implements BottomSheetImagePicker.OnImagesSelectedListener {
            ...
            case "Men's Apparel":
                ...
                nextBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra("mensSizeChart", MemoryData.getUri(offerItem_S2.this));
            ...
            case "Women's Apparel":
                ...
                nextBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra("womensSizeChart", MemoryData.getUri(offerItem_S2.this));
    ...
    public void onImagesSelected(@NotNull List<? extends Uri> uris, @Nullable String tag) {
        for (Uri uri : uris) {
            ...
            MemoryData.saveUri(uri.toString(), offerItem_S2.this);
        }
    }
